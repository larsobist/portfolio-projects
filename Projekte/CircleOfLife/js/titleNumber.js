...
var VFont = function() {
    ...
    this.setSize = function() {
        var fontSize = window.innerWidth / (str.length / 4);
        title.style = "font-size: " + fontSize + "px;";
        title.style = "width: 100%"
        if (this.scale) {
            var scaleY = (window.innerHeight / title.getBoundingClientRect().height).toFixed(2);
            var lineHeight = scaleY * 1.8;
            title.style = "font-size: " + fontSize + "px; transform: scale(2," + scaleY + "); line-height: " + lineHeight + "em;"
        }
    }
